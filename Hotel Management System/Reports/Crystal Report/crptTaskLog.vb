...
Public Class crptTaskLog
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.crptTaskLog.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptTaskLog
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptTaskLog = New crptTaskLog()
        rpt.Site = Me.Site
        Return rpt
    End Function

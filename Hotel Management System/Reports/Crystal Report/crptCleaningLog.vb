...
Public Class crptCleaningLog
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.crptCleaningLog.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptCleaningLog
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptCleaningLog = New crptCleaningLog()
        rpt.Site = Me.Site
        Return rpt
    End Function

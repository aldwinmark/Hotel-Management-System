...
Public Class crptMonthlyTrans
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.crptMonthlyTrans.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptMonthlyTrans
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptMonthlyTrans = New crptMonthlyTrans()
        rpt.Site = Me.Site
        Return rpt
    End Function

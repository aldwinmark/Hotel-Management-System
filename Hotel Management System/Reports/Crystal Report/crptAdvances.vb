...
Public Class crptAdvances
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.crptAdvances.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptAdvances
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptAdvances = New crptAdvances()
        rpt.Site = Me.Site
        Return rpt
    End Function

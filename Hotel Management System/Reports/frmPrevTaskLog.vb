...
Public Class frmPrevTaskLog
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        rptfrmTaskLog.CrystalReportViewerTaskLog.ReportSource = repDoc

        rptfrmTaskLog.CrystalReportViewerTaskLog.SelectionFormula = "{tblRoomCleaning.DatetimeCreated}>=#" & Me.dtpDatefrom.Value.ToShortDateString & " 12:00:00 AM# AND {tblRoomCleaning.DatetimeCreated}<=#" & Me.dtpDateto.Value.AddDays(1).ToShortDateString & " 12:00:00 AM#"

        rptfrmTaskLog.ShowDialog()

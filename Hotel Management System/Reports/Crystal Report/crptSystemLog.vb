...
Public Class crptSystemLog
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.crptSystemLog.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptSystemLog
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptSystemLog = New crptSystemLog()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class crptCashCount
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.crptCashCount.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptCashCount
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptCashCount = New crptCashCount()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class crptRoomsLog
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.crptRoomsLog.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptRoomsLog
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptRoomsLog = New crptRoomsLog()
        rpt.Site = Me.Site
        Return rpt
    End Function

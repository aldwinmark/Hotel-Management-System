...
Public Class crptAdvanceMonthly
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.crptAdvanceMonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptAdvanceMonthly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptAdvanceMonthly = New crptAdvanceMonthly()
        rpt.Site = Me.Site
        Return rpt
    End Function
